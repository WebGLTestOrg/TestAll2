...
System.register("chunks:///_virtual/main", ['./PlaneDynamicText.ts', './ClickMoveBinding.ts', './ColorLibrary.ts', './FreeCamera.ts', './GlobalClickManager.ts', './InteractionState.ts', './PieceSpawner.ts', './PointerIds.ts', './RandomOpenButton.ts', './RotateYByKeys.ts', './ScreenShotExample.ts', './StartApp.ts', './UIScaleBounce.ts', './VerticalMoveAroundTarget.ts'], function () {
  return {
